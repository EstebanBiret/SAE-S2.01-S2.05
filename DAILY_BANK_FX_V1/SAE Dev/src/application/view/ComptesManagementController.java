...
public class ComptesManagementController implements Initializable {
	...
	private void doVoirOperations() {
		System.out.println("test  ComptesManagementController.doVoirOperations av select");
		int selectedIndice = this.lvComptes.getSelectionModel().getSelectedIndex();
		System.out.println("test  ComptesManagementController.doVoirOperations ap" + selectedIndice);
		if (selectedIndice >= 0) {
			System.out.println("test  ComptesManagementController.doVoirOperations av" + selectedIndice);
	...
	private void doGenererPdf() {
		Document document = new Document();
	      ...
	      try
	      {
	         PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("C:\\Users\\Etudiant\\Downloads\\Releve-mensuel.pdf"));
	         document.open();
			 ...
			 alert.setContentText(" Le pdf se situe dans votre répertoire téléchargement avec le nom : Relevé-Mensuel.pdf");
