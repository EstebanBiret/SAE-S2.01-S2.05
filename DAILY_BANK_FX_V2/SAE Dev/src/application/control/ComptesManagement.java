...
public class ComptesManagement {
	...
	public ArrayList<Operation> recupOperation(CompteCourant compte) {
        ArrayList<Operation> ope = null;
        String operation = null;
        if(compte != null) {
            try {
                AccessOperation acpt = new AccessOperation();
                ope = acpt.getOperationsMois(compte.idNumCompte);
